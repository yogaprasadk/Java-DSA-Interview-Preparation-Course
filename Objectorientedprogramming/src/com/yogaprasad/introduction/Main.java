...
public class Introduction {
    public static void main(String[] args) {
        ...
        //Class - Class  is a name,group of functions and properties.
 ...
 //       Student yoga = new Student();  // yoga is a reference variable // referencing variable - yoga is initialized to object Student
     ...
     //   System.out.println(yoga); // if you print the reference variable it will give output as com.yogaprasad.introduction.Student@6acbcfc0   (@6acbcfc0 - randomly generated)
