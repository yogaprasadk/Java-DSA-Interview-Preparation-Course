...
public class wrapper {
    public static void main(String[] args) {
        ...
        A n = new A("kunal");
        System.out.println(n); // output : introduction.A@312b1dae
        // we dont want to print the hash value.
        // we want whenever we try to print the object A it needs to print the instance variables objects.
        // if the instance variable objects needs to print we need to use @override.
    }
